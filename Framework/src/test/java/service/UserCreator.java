...
public class UserCreator {
    ...
    return new User(TestDataReader.getTestData(TESTDATA_USER_NAME), TestDataReader.getTestData(TESTDATA_USER_LASTNAME), TestDataReader.getTestData(TESTDATA_USER_REGISTRATIONEMAIL), TestDataReader.getTestData(TESTDATA_USER_LASTNAME));
    }
}
